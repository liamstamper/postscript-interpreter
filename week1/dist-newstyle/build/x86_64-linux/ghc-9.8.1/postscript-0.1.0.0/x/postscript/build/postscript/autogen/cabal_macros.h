...
/* package postscript-0.1.0.0 */
#ifndef VERSION_postscript
#define VERSION_postscript "0.1.0.0"
#endif /* VERSION_postscript */
#ifndef MIN_VERSION_postscript
#define MIN_VERSION_postscript(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_postscript */
...
#define CURRENT_COMPONENT_ID "postscript-0.1.0.0-inplace-postscript"
